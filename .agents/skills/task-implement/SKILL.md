...
This skill is **Mintkey-specific**. It assumes the repository structure described in [`AGENTS.md`](../../../AGENTS.md) / [`AGENTS.md`](../../../AGENTS.md), the Phase-1 task list at `.kiro/specs/mintkey-mvp/tasks.md`, and the 17 accepted ADRs under `docs/architecture/01-architecture/adr/`.
...
- [`AGENTS.md`](../../../AGENTS.md) — Codex-flavored sibling (kept in lock-step with AGENTS.md).
