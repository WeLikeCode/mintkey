...
- [x] 6.1 — Update `README.md` repo map (R-6.1)
- [x] 6.2 — Update `KIRO.md` link hub (R-6.2)
- [x] 6.3 — Update `AGENTS.md` and `CLAUDE.md` (R-6.3)
- [x] 6.4 — Sweep `.kiro/specs/*` for stale paths (R-6.4)
- [x] 6.5 — Sweep `.kiro/steering/*` for stale paths (R-6.5)
- [x] 6.6 — Sweep `docs/` (HOW-TO, DEBUG, DEPLOYMENT, RELEASE, NETWORK, AUTH, DEV-TEST, patterns, architecture/00-vision) (R-6.6)
- [x] 6.7 — Update `PORTS.md` if it references compose paths (R-6.7)
- [x] 6.8 — Confirm `Makefile` targets reflect new paths (R-6.8)
- [x] 6.9 — Update `.github/workflows/*` paths-filters (R-6.9)
