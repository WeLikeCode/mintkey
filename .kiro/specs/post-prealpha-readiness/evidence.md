...
| HOWTO backup-before-reset document exists | `team/remediation/HOWTO-backup-before-reset.md` on main (PR #72 + #75) | yes | `ls -la team/remediation/HOWTO-backup-before-reset.md` returns 15201 bytes |
...
| `otel-collector` restart loop fixed | `otel-collector-config.yaml` repaired for v0.104+ (PR #48; session 2026-05-17) | yes | File exists: `ls otel-collector-config.yaml`; `team/remediation/2026-05-17-otel-collector-config/` exists |
...
| Scorecard session record exists | `team/remediation/2026-05-18-s11-scorecard-residuals/` directory | yes | `ls team/remediation/2026-05-18-s11-scorecard-residuals/` |
