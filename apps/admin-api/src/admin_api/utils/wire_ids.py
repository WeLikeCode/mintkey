...
Source: ADR-0017.11; #13 (wire-form unification).
"""
...
def db_uuid_to_wire(uuid_value: Union[str, _uuid_mod.UUID], prefix: str) -> str:
    ...
    prefix : str
        The resource prefix WITHOUT trailing underscore, e.g. "agent", "svc".
    ...
    Example
    -------
    >>> db_uuid_to_wire("6c3c950a-2e18-4ba9-8c89-5b875b1bf5bd", "agent")
    'agent_0DMZAJ0H0J5A1KJ2QM3WK6FKTH'
    """
...
def wire_to_db_uuid(wire_id: str, prefix: str) -> str:
    ...
    prefix pattern (allows callers to pass raw UUID strings too).
