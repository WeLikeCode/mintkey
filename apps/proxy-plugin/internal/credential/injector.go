...
const (
	...
	AuthSchemeHTTPDigest            AuthScheme = 17 // mirrors AUTH_SCHEME_HTTP_DIGEST = 17; RFC 2617 Digest handshake performed by a per-request digest.Transport, not a static header.
)
