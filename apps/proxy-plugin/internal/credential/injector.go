...
const (
	...
	AuthSchemeAppleJWT              AuthScheme = 9  // mirrors AUTH_SCHEME_APPLE_JWT = 9; JWT generated by Vault Adapter, proxy treats opaquely as bearer.
	...
	AuthSchemeHTTPDigest            AuthScheme = 18 // mirrors AUTH_SCHEME_HTTP_DIGEST = 18 (17 reserved for the admin-api-only email_oauth2_client synthetic); RFC 2617 Digest handshake performed by a per-request digest.Transport, not a static header.
)
...
func Inject(req *http.Request, cred Credential) error {
	...
	case AuthSchemeBearerToken, AuthSchemeAppleJWT, AuthSchemeGoogleServiceAccount:
