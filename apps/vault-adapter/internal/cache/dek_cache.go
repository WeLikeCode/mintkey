...
// plaintext.
func (c *DEKCache) Put(tenantID, serviceID string, keyVersion uint32, wrappedDEK, encPayload []byte, authScheme int32, isRevoked bool, targetURL, headerName, queryParam, targetAddress, sshUser, serviceBaseUrl string) {
